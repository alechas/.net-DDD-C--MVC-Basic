...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div id="load" class="content-left">
		<nav class="nav-content-left">
			<ul>
				<li class = "active">
					<a id="menu1" href="<%:Url.Content("~/menu/promo")%>#target"><span>Hot Promo</span></a>
				</li>
				<li>
					<a id="menu2" href="<%:Url.Content("~/menu/hemat")%>#target"><span>Hot Hemat</span></a>
				</li>
                 <li>
					<a id="menu5" href="<%:Url.Content("~/menu/doublepizza")%>#target"><span>Double Pizza</span></a>
				</li>
				<li>
					<a id="menu3" href="<%:Url.Content("~/menu/hotmenu")%>#target"><span>Hot Menu</span></a>
				</li>
				<li>
					<a id="menu4" href="<%:Url.Content("~/menu/favorite")%>#target"><span>My Favorite</span></a>
				</li>
        ...
        <input type="hidden" id="hidvalue" name="hidvalue" value="" />
			...
			<div class="hot-promo-container">
				...
				<div class="slide-container">
                    ...
                    <% foreach (var item in ViewBag.menupromo)
                        {%>
					    <li>
						    ...
						    <input value="pesan" class="order-button" type="button" onclick="setvalue(<%:item.Id %>);"/> 
                            <%} %>
					    </li>
                        <%
                        } %>
