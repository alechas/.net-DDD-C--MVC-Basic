...
<!DOCTYPE html>
    ...
    <div class="menu-title">
	    <img src="../../Content/_design/images/snacktittle.png">
    </div>
    <div class="content-left">
		...
		<div class="content-left-container">
		    ...
		    <div class="menu-common">
			    <h1>
				    <img src="../../Content/_design/images/Logo_Snacks.png">
			    </h1>
			    <div class="price-group">
				    <h2>
					    <img src="../../Content/_design/images/Harga_18.png">
				    </h2>
				    <ul class="clearfix">
					    <li class="menu-list">
						    <span><a href="#" class="spin"></a><br><a href="#" class="sfb"></a><a href="#" class="stwt"></a><b class="ttlshare"></b></span>
						    <div class="menu-image">
							    <img  src="../../Content/_design/images/snacks - MozzSticks.png">
						    </div>
						    <h4>Mozz Sticks</h4>
						    <p>2 Jenis keju mozzarella yang gurih dinikmati dengan saus Thousand Island atau HOTmix.
						    </p>
			    ...
			    <div class="price-group">
				    <h2>
					    <img src="../../Content/_design/images/Harga_20.png">
				    </h2>
				    <ul class="clearfix">
					    <li class="menu-list">
						    <span><a href="#" class="spin"></a><br><a href="#" class="sfb"></a><a href="#" class="stwt"></a><b class="ttlshare"></b></span>
