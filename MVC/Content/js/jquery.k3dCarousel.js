	...
	$.fn.k3dCarousel=function(options) {  
		return this.each(function() {
			var i=0, sin, position, newWidth, numitems, degs,
				...
				settings = {
					"r"  : w*.2, // radius of the carousel
					"cX" : w/3,  // center X of the carousel
					"cY" : this.offsetHeight/3, // center Y
					"sT" : 100, // how long it takes to move from spot to spot
